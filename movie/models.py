...
class Movie(models.Model):
    ...
    fees_to_usa = models.PositiveIntegerField('Сборы в США',  default=0, help_text='Указывать в долларах')
    fees_to_world = models.PositiveIntegerField('Сборы в Мире',  default=0, help_text='Указывать в долларах')
